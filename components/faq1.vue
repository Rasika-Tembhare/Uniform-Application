<template>
  ...
  >
    ...
    >
      <span> Which board is this school affiliated to?</span>
    ...
    <div class="collapse-content" v-if="isHidden">
      <p>
        In India all Schools that have classes upto Xth or XIIth have to be
        affiliated to atleast one board of education.{{ school?.school_name }},
        {{ school?.school_city }} is affiliated to the the following boards:
        {{ school?.school_board }}.
      </p>
    </div>
  </div>
